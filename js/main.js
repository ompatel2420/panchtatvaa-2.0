...
/*------------------------------------------------------------------------------*/
   // makes sure the whole site is loaded
    $(window).on("load",function(){
        $(".loader-blob").fadeOut(),$("#preloader").delay().fadeOut("slow",function(){$(this).remove()})
    })
...
/*------------------------------------------------------------------------------*/
    ...
    jQuery( document ).ready(function($) { panchtatvaa_logMarginPadding_content();});
    function panchtatvaa_logMarginPadding_content(){ 
    ...
    }jQuery(window).resize(function() {panchtatvaa_logMarginPadding_content(); });
